...
import { microserviceClient, type ProcessingResult } from '@/lib/microservice-client'
...
export default function PDFUpload({
  ...
  useEffect(() => {
    ...
    const checkSubmissionService = async () => {
      try {
        const available = await microserviceClient.isSubmissionServiceAvailable()
      ...
      for (const uploadedFile of newFiles) {
        try {
          ...
          if (submissionServiceAvailable) {
            ...
            const result: ProcessingResult = await microserviceClient.processPDF(uploadedFile.file)
